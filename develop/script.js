// This is the Moment.js
var currentDate = moment().format('dddd') + " " + moment().format("Do MMM YYYY");
var currentHour = moment().format('h:mm:ss a');
// This is the text hour var
var nineAm = $("#9am");
var tenAm = $("#10am");
var elevenAm = $("#11am");
var twelvePm = $("#12pm");
...
// This line of code represents the date and hour
...
$(document).ready(function(){
  ...
  // The button will save input to local storage
  ...
  // This is the button to clear the day
